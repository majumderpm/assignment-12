...
const Footer = () => {
  ...
  <div>
  <Link className="text-3xl uppercase font-semibold font-serif tracking-wide text-white" to="/">tixly</Link>
    <p className="font-bold">
    tixly Industries Ltd. <br/>Providing Products Resale Market
    </p> 
